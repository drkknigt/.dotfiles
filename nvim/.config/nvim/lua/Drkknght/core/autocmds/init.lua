...
-- autocmd to auto format with lsp
autocmd("BufWritePost", {
    group = api.nvim_create_augroup("formatting", { clear = true }),
    pattern = "*",
    desc = "format via lsp",
...
-- autocmd to set highlights
autocmd("CursorHold", {
    group = api.nvim_create_augroup("DiagnosticLspShow", { clear = true }),
    pattern = "*",
    desc = "format via lsp",
    callback = function()
