...
set.nrformats = set
    .nrformats -- This defines what bases Vim will consider for numbers when using the CTRL-A and CTRL-X commands for adding to and subtracting from a number
...
set.timeoutlen = 200                -- Time in milliseconds to wait for a mapped sequence to complete.
